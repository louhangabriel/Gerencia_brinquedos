...
<body>
	<?php
		...
		if(isset($_POST['bt_type_finaliza'])){
			if($_POST['type_finaliza']=="finali_guard"){
	?>	
			<h2>Guarda usada:</h2>
			<form name="form_finali_raspagem" method="POST">
				<select>
	...
	<?php
		}elseif($_POST['type_finaliza']=="finali_pass"){
	...
	<?php
		}elseif($_POST['type_finaliza']=="finali_mov"){
	?>

	<?php
		}elseif($_POST['type_finaliza']=="finali_outro"){
	...
	?>
		...
		?>
			...
			<form name="type_finaliza" method="POST">
